...
/**
 * Service layer for handling business logic related to the "ReviewRepositoryInterface" repository.
 */
class ReviewService
{
    /**
     ...
     *
     * @param \App\Repositories\Interfaces\ReviewRepositoryInterface $repository
     */
